    ...
    <div className="flex min-h-screen bg-gray-100">
      ...
      <main className="flex-1">
        ...
        <header className="flex justify-between items-center bg-white shadow px-6 py-4">
          <h1 className="text-2xl font-bold text-blue-900">Welcome{user?.name ? `, ${user.name}` : ""} </h1>
        ...
        <section className="p-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-white p-6 rounded-lg shadow hover:shadow-lg transition">
            ...
            <ul className="space-y-2">
              <li className="p-3 border rounded-lg hover:bg-blue-50">
                ProTrack - 30% complete
              </li>
            </ul>
          </div>
          ...
          {/* Task Tracker */}
          <div className="bg-white p-6 rounded-lg shadow hover:shadow-lg transition">
            <h2 className="text-xl font-bold mb-2 p-2 rounded-2xl bg-black text-yellow-400 text-center">
              Show All Task{" "}
            </h2>
            <h2 className="text-xl font-bold mb-4">Task Tracker</h2>
            <p>
              Completed: <span className="font-bold text-green-600">12</span>
            </p>
            <p>
              Pending: <span className="font-bold text-red-600">5</span>
            </p>
          ...
          <div className="bg-white p-6 rounded-lg shadow hover:shadow-lg transition">
            ...
            <div className="p-3 border rounded-lg mb-2">
              "Good progress on ProTrack. Improve documentation." - Prof. Sunita
              Naik
            </div>
