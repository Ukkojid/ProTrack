        ...
        <section className="p-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-white p-6 rounded-lg shadow">
            ...
            <ul className="space-y-2">
              <li className="p-3 border rounded hover:bg-blue-50">Deepak Sharma - AI Project</li>
              <li className="p-3 border rounded hover:bg-blue-50">Riya Patel - Web Development</li>
            </ul>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow">
            ...
            <p>✔️ 12 Projects Supervised</p>
            <p>📑 8 Feedbacks Given</p>
            <p>📊 Avg Completion: 75%</p>
          </div>
        </section>
      </main>
    </div>
